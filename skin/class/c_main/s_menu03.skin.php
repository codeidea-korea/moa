...
$sql = "select a.day, b.it_price, c.moa_onoff, c.moa_area1, c.wr_subject, c.as_thumb, (select sum(is_score) from g5_shop_item_use where it_id = b.it_id) as score, (select count(*) from g5_shop_item_use where it_id = b.it_id) as cnt  
