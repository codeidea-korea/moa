        ...
        <div class="wrapper">
            <div class="content">
                <div class="line_input">
                    ...
                    <input type="email" placeholder="예) moa@moa.co.kr" onkeyup="characterEmailCheck(this)" oninvalid="this.setCustomValidity('이메일을 입력해주세요.')" oninput="this.setCustomValidity('')" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" required <?php echo $readonly ?> class="form-input half_input required <?php echo $readonly ?>" minlength="3" maxlength="150">
                    <p>비밀번호</p>
                    <input type="password" type="password" name="mb_password" oninvalid="this.setCustomValidity('비밀번호를 입력해주세요.')" oninput="this.setCustomValidity('')" id="reg_mb_password" required placeholder="한글 또는 영문, 숫자로 8자 이상 작성해주세요. ">
                    <p>비밀번호 확인</p>
                    <input class="error" type="password" name="mb_password_re" id="reg_mb_password_re" required placeholder="비밀번호 확인">
                    <span class="warning">한글 또는 영문, 숫자로 8자 이상 작성해주세요. </span>
                    <p>이름</p>
                    ...
                    <div class="position_layout">
                        ...
                        <input type="text" oninvalid="this.setCustomValidity('닉네임을 입력해주세요.')" oninput="this.setCustomValidity('')" name="mb_nick" value="<?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : ''; ?>" id="reg_mb_nick" required class="form-input required nospace  half_input" size="10" maxlength="20" placeholder="한글 또는 영문, 숫자로 작성해주세요. "
                    ...
                    <p>성별</p>
                    <div class="position_layout">
                        <div class="radio_area" style="padding:0;">
                    ...
                    <div class="checkbox">
                        ...
                        <div class="all_agree">
                            <span class="title-name">
                                ...
                                <label for="allowed_marketting_news" class="font-normal">마케팅 정보 수신 동의 (선택)</label>
                            </span>
                        </div>
...
<script>
    ...
    $('#chk_all').click(function() {
        if (!$(this).is(':checked')) {
            $('.title-name input').attr('checked', false);
        } else {
            $('.title-name input').attr('checked', true);
        }
    })
</script>
<!-- 1128 경력 슬라이더 추가 끝 -->
<script>
    function characterEmailCheck(obj){
        var regExp = /[ \{\}\[\]\/?,;:|\)*~`!^+┼<>\#$%&\'\"\\\(\=]/gi; 
...
//            obj.value = obj.value.substring( 0 , obj.value.length - 1 );
    ...
    $(function() {
        ...
        $('#fregisterform').submit(function() {
            ...
            var agree21 = $("#agree21").is(":checked");
            if (!agree21) {
            ...
            const birthYear = $('#reg_mb_birth').val().split('-')[0];
