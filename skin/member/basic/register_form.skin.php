...
<form class="form-horizontal register-form" role="form" id="fregisterform" name="fregisterform" action="<?php echo $action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
	...
	<div class="container grid-lgpanel-default">
	...
	<div class="container grid-lgpanel-default">
		...
		<?php if ($member['mb_level'] >= $config['cf_icon_level'] && $config['cf_member_img_size'] && $config['cf_member_img_width'] && $config['cf_member_img_height']) {  ?>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="reg_mb_img"><b>작가 이미지 등록</b></label>
				<div class="col-sm-9">
		...
		<?php }  ?>
			...
			<div class="form-group">
				<label class="col-sm-2 control-label" for="reg_mb_profile"><b>주요 경력</b><?php if ($config['cf_req_profile']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
				<div class="col-sm-9">
					<textarea placeholder="ex) 2017~2019 아시아프 연속 참가" name="mb_profile" rows=10 id="reg_mb_profile" <?php echo $config['cf_req_profile']?"required":""; ?> class="form-control input-sm"><?php echo $member['mb_profile'] ?></textarea>
				</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-2 control-label" for="reg_mb_signature"><b>그 밖의 간략한 소개</b><?php if ($config['cf_req_signature']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
				<div class="col-sm-9">
					<textarea name="mb_signature" rows=10 id="reg_mb_signature" <?php echo $config['cf_req_signature']?"required":""; ?> class="form-control input-sm"><?php echo $member['mb_signature'] ?></textarea>
				</div>
			</div>          
			<div class="form-group has-feedback">
				<label class="col-sm-2 control-label" for="reg_mb_1"><b>해쉬태그#</b></label>
				<div class="col-sm-5">
					<input type="text" name="mb_homepage" value="<?php echo get_text($member['mb_1']) ?>" id="reg_mb_1" class="form-control input-sm" size="70" maxlength="255">
					<span class="fa fa-hash form-control-feedback"></span>
				</div>
				※ 콤마(,)로 구분해서 입력하세요!
			</div>
			<?php
