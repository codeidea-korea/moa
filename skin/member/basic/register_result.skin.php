...
<div class="panel panel-default">
	<div class="panel-heading none"><h4><strong><i class="fa fa-birthday-cake fa-lg"></i> <strong><?php echo $mb['mb_name'] ?></strong>님의 회원가입을 진심으로 축하합니다.</strong></h4></div>
    ...
    <div>
        <div class="layerBody">
            <div class="confirm">
                <div class="mentBox">
                    <img src="../images/comp_ic.svg" alt="">
                    <p class="t_bold">
                        [회원가입 완료]<br>
                        <?php echo $mb['mb_name'] ?>님,<br>
                        moa에 오신걸 환영합니다!.</p>
                    <div class="p17">
                        <button class="inactive on h45" onclick="location.href='<?php echo G5_URL; ?>';">확인</button>
                    </div>
                </div>
            </div>
        </div>
