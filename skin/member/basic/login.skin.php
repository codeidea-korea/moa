...
//echo "skinurl:".$skin_url."<BR>";
if($header_skin)
	include_once('./header.php');
?>

<link rel="stylesheet" href="<?=G5_ADMIN_URL?>/css/iconfont/newfont/style.css">
<link rel="stylesheet" href="<?=G5_ADMIN_URL?>/css/iconfont/intaefont/style.css">
<link rel="stylesheet" href="/skin/member/basic/style.css?ver=2205010" media="screen">


<style>
header.header, nav, #moa-header-space, .alert02, .i_laypop, #moa-footer-nav, #moa-footer-nav-space {display:none !important;}
</style>
...
<section id="login-wrapper">
	...
	<input type="hidden" name="url" value='<?php echo $login_url ?>'>
		<div class="inner">
			...
			<div class="logo"><img src="../images/moa_logo.svg"></div>
			<div class="title-sub">관리자 로그인</div>
			<label class="input-wrap icon-login-id">
				<span>아이디 :</span>
				<input type="text" name="mb_id" id="login_id" required class="form-control input-sm" size="20" maxLength="20" placeholder="아이디(이메일)를 입력해주세요.">
				<!--<input type="text" name="#" id="" required class="span" placeholder="아이디(이메일)를 입력해주세요.">-->
			</label>
			<label class="input-wrap icon-login-pw">
				<span>비밀번호 :</span>
				...
				<!--<input type="password" name="#" id="" required class="span" placeholder="비밀번호를 입력해주세요.">-->
			</label>
			<button type="submit" class="btn-login">로그인</button>
			<ul class="sbtn-set">
				<li><label class="checkbox-wrap"><input type="checkbox" name="auto_login" id="login_auto_login"><span></span>로그인 유지</label></li>
				<li><a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">비밀번호 찾기</a></li>
			</ul>			
			<div class="btn-set">
				<a href="./register.php" class="btn large reverse gray">또 다른 관리자 회원가입</a>
			</div>	
		</div>
	</form>
	</div>
...
<div style="max-width:340px; margin:0 auto; display:none;">
	<div class="form-box">
