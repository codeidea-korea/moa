    ...
    <div class="wrapper detail_wrap">
            ...
            <div class="swiper9">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="<?= $data['as_thumb']; ?>" alt="" height="298px">
                    </div>
                    <?php
                        $likechk = checkLikeOn('class',$data['wr_id'], $member['mb_id']);
                        $likeon = ($likechk)?"on":"";
                        $likenoon = ($likechk)?"":"";
                    ?>
                    <button class="lick_btn <?= $likeon; ?>" onclick="deb_goods_like(<?php echo $data['wr_id'] ?>, 'good'); return false;"></button>
                </div>
        ...
        <div class="s_content detail_con">
            <div class="dt_con1">
                ...
                <span class="tit_chip"><?= $data['moa_onoff']; ?></span>
            </div>
            <div class="clctn_ic">
                <div>
                    <img src=".././images/meet_icon/위치.svg" alt="">
                    <p><?= get_common_type($data['moa_area1'])['type_name']; ?></p>
                    <span><?= get_common_code_name($data['moa_area1'], $data['moa_area2'])['cd_name']; ?></span>
                </div>
                <div>
                    <img src=".././images/meet_icon/clock_ic.svg" alt="">
                    <p>1회당</p>
                    <span><?= $data['moa_totime'] ?></span>
                </div>
                <div>
                    <img src=".././images/meet_icon/personnel_ic.svg" alt="">
                    <p><?= $data['wr_1'] ? $data['wr_1'] : 0; ?>명</p>
                    <span>최소 인원 <?= $data['wr_5'] ? $data['wr_5'] : 0; ?>명</span>
                </div>
                <div>
                    <img src=".././images/meet_icon/<?= $data['moa_type'] ?>.svg" alt="">
                    <p><?= $data['moa_type']; ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="s_content detail_con">
            ...
            <div class="owchip_area">
                <div class="owchip_recru on">
                    ...
                    <p>(<?= getAplyCountIt($data['it_id']) ?>/<?= $data['wr_1']; ?>명)</p>
                </div>
            ...
            <?php if($data['moa_supplies']) { ?>
                <div class="d_tit cr mt14">
                    ...
                    <div class="com_chip color_red">
                        <span><?= $data['moa_supplies'] ?></span>
                    </div>
                </div>
            <?php } ?>
            <!-- map -->
            <div class="mt25">
                <img style="width:100%" src="../images/visual_img/map.png" alt="">
            </div>
        </div>
    </div>
	...
	<div class="column col-4 col-md-12">
		<form name="fitem" method="post" action="<?php echo $action_url; ?>" class="form" role="form" onsubmit="return fitem_submit(this);">
			...
			<div class="item-form-footer text-center" width="100%" >
				...
				<button class="btn btn-primary btn-lg btn-block"  onclick="document.pressed=this.value;" value="바로구매" >바로 모임신청</button>
