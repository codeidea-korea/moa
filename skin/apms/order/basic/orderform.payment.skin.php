...
<?php if (!$default['de_card_point']) { ?>
	<div class="well" id="sod_frm_pt_alert"  style="display:none;">>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<label class="col-sm-2 control-label">
					<b><span id="od_tot_price2"><?php echo number_format($tot_price); ?></span></b>원
				</label>
			</div>
			...
			<?php } else { ?>
				<div class="form-group">
					...
					<div class="col-sm-10 radio-line">
						...
						<?php if($is_card) { ?>
							<label><input type="radio" id="od_settle_card" name="od_settle_case" value="신용카드" checked> 신용카드</label>
						<?php } ?>
				...
				$(function() {
					...
					//$("#od_settle_bank input:radio").on("ifClicked", function (ev) {
					$("#od_settle_card input:radio").on("ifClicked", function (ev) {
				...
				<?php if($is_mu) { ?>
					<div id="settle_bank" >
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" name="od_deposit_name" id="od_deposit_name" class="form-control input-sm" size="10" maxlength="20" value="<?php echo $member['mb_nick'];?>">
							</div>
						</div>
					</div>
				<?php } ?>
