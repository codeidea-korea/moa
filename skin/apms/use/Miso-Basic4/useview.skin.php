...
<div class="view-wrap<?php echo (G5_IS_MOBILE) ? ' view-mobile font-14' : '';?>">
	...
	<div class="panel panel-default view-head" style="border-bottom:0;">
		<div class="panel-heading">
			<div class="font-12 text-muted">
				<?php echo apms_get_star($view['is_score'], $scolor.' font-14'); //별점 ?>
				<span class="sp"></span>
	...
	<div class="view-sns text-right">
		<?php 
			...
			echo  get_sns_share_link('twitter', $sns_url, $sns_title, $sns_img.'/sns/twitter.png').' ';
				...
				<div class="media">
					...
					<div class="media-body">
						...
						<div class="media-info text-muted">
							<?php echo apms_get_star($view['it_use_avg'], $scolor.' font-14'); //평균별점 ?>
							<span class="sp"></span>
...
<div class="view-btn">
	<div class="form-group pull-left">
		<div class="btn-group">
			<a href="./itemuselist.php?sfl=<?php echo urlencode('a.it_id');?>&amp;stx=<?php echo urlencode($view['it_id']);?>" class="btn btn-<?php echo $btn2;?> btn-sm"><i class="fa fa-eye"></i> 더보기</a>
		</div>
	</div>
	<div class="form-group pull-right">
		<div class="btn-group">
			<?php if($view['is_edit_href']) { ?>
				<a href="<?php echo $view['is_edit_href']; ?>" class="btn btn-<?php echo $btn1;?> btn-sm"><i class="fa fa-plus"></i><span class="hidden-xs"> 수정</span></a>
			<?php } ?>
			<?php if($view['is_del_href']) { ?>
				<a href="<?php echo $view['is_del_href']; ?>" class="btn btn-<?php echo $btn1;?> btn-sm"><i class="fa fa-times"></i><span class="hidden-xs"> 삭제</span></a>
			<?php } ?>
			<a href="./itemuselist.php?<?php echo $qstr;?>" class="btn btn-<?php echo $btn1;?> btn-sm"><i class="fa fa-bars"></i> 목록</a>
		</div>
	</div>
