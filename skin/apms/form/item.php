		...
		<?php if($is_auth) { // 관리자일 때만 출력 ?>
			...
			<tr>
				...
				<td>
					...
					&nbsp;
					<input type="checkbox" name="pt_plan" value="1" <?php echo ($it['pt_plan'] ? "checked" : ""); ?> id="pt_plan">
					<label for="pt_plan">기획전</label>
					&nbsp;
					<input type="checkbox" name="pt_pick" value="1" <?php echo ($it['pt_pick'] ? "checked" : ""); ?> id="pt_pick">
					<label for="pt_pick">모아'Pick</label>
				</td>
			</tr>
		<?php } // 관리자 끝 ?>
        <tr>
