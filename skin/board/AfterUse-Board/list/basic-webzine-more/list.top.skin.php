	...
	<div class="list-top pull-right">
		<div class="btn-group">
			...
			<?php if ($is_checkbox || $setup_href || $admin_href) { ?>
				<?php if ($is_checkbox) { ?>
					<a href="#" class="btn btn-<?php echo $btn1;?> btn-sm" data-toggle="modal" data-target="#adminModal" onclick="return false;"><i class="fa fa-th-large" title="글관리" ></i></a>
				<?php } ?>
				<?php if ($setup_href) { ?>
					<a href="<?php echo $setup_href; ?>" class="btn btn-<?php echo $btn2;?> btn-sm win_memo" title="추가설정"><i class="fa fa-cogs"></i></a>
				<?php } ?>
				<?php if ($admin_href) { ?>
					<a href="<?php echo $admin_href; ?>" class="btn btn-<?php echo $btn1;?> btn-sm" title="보드설정"><i class="fa fa-cog"></i></a>
				<?php } ?>
			<?php } ?>
			<?php if ($list_href) { ?>
