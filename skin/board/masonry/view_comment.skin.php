...
<section id="bo_vc">
    ...
    for ($i=0; $i<$cmt_amt; $i++) {
		...
		// 모바일과 PC의 접속에 따라서 depth를 각각 적용 함
		if ( is_mobile() ) {
...
<aside id="bo_vc_w" class="bo_vc_w">
	...
	<!-- 댓글 아이디, 비번 -->
	<?php if ($is_guest) { ?>
	<div class="bo_vc_w_form_wrap">
		<div class="bo_vc_w_form_control">
			<label for="wr_name" class="">이름 *<strong class="sound_only"> 필수</strong></label>
		...
		<div class="bo_vc_w_form_control">
			<label for="wr_password" class="">비밀번호 *<strong class="sound_only"> 필수</strong></label>
