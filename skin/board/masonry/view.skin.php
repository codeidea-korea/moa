...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<div id="bo_v_top">
		...
		<ul class="btn_bo_user bo_v_com">
			<li class="view_btn_list"><a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><i class="fa fa-list" aria-hidden="true"></i><span class="">목록</span></a></li>
			<?php if ($reply_href) { ?><li class="view_btn_reply"><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fa fa-reply" aria-hidden="true"></i><span class="">답변</span></a></li><?php } ?>
			<?php if ($write_href) { ?><li class="view_btn_wirte"><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="">글쓰기</span></a></li><?php } ?>
    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		...
        		<span class="">조회</span><strong><i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?>회</strong>
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_act">
            ...
            <?php } ?>
            <?php if ($nogood_href) { ?>
			<div class="gw_btn_bad">
				<a href="<?php echo $nogood_href.'&amp;'.$qstr ?>" id="nogood_button">
					<span class="bo_v_nogood"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i><span class="txt">비추천</span></span>
    ...
    <ul class="bo_v_nb">
		...
		<?php } else { ?>
			<a href="javascript:;" class="btn_prv no_link">
				<span class="nb_tit">이전글이 없습니다.</span>
			</a>
		<?php } ?>
		<div class="nb_list" title="리스트로 이동">
			<a href="<?php echo $list_href ?>" class="btn_b01 btn" title="목록"><span class="sound_only">목록</span></a>	
		</div>
        <?php if ($next_href) { ?>
		...
		<?php } else { ?>
			<a href="javascript:;" class="btn_next no_link" >
				<span class="nb_tit">다음글이 없습니다.</span>
			</a>
		<?php } ?>
    </ul>
    <?php } ?>
