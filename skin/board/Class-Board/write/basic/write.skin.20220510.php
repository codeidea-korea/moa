...
?>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<?php
			$cnt = 1;
			foreach($moatype as $key => $value) {?>
			<input type="radio" name="moa_type" id="moa_type<?php echo $cnt;?>" value="<?php echo $value; ?>"
				 class=""
...
<?php // 온오프라인 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="as_tag">온.오프라인</label>
		<div class="col-sm-10">
