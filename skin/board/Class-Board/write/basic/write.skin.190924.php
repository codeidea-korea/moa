...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">강의제목<strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
		<div class="input-group">
			<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control input-sm" style="max-width:500px;width:100%"size="50" maxlength="255">
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">강의내용<strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
...
?>
	...
	<div class="form-group" style="display:none">
		<a class="btn btn-<?php echo $btn2;?> btn-sm" id="btnAddDays" style="width:300px">강의일시 일괄생성</a>
	</div>
<div class="form-group">
		<label class="col-sm-2 control-label hidden-xs">강의 일시</label>
		<div class="col-sm-10">
			<p class="form-control-static text-muted" style="padding:0px; padding-top:4px;">
				<span class="cursor" onclick="add_class_item();"><i class="fa fa-plus-circle fa-lg"></i> 강의 일시 추가</span>
				&nbsp;
				<span class="cursor" onclick="del_class_item();"><i class="fa fa-times-circle fa-lg"></i> 강의 일시 삭제</span>
			</p>
		</div>
	</div>
	...
	function add_class_item(delete_code,values) {
		...
		*/
		...
		if (values) 
			...
			objContent += "<div class='col-sm-10'><div class='form-group'><div class='input-group input-group-sm '><select name='cls_type[]' class='form-control'><option value='0'>본강의 </option><option value='1'>보조강의</option></select><input type='text' class='form-control input-sm cls_date' name='cls_day[]' placeholder='강의일자 '>:<select class='form-control input-sm ' name='cls_time[]' placeholder='강의시간 '>";
			var t = "";
			for (var j = 8; j < 20;j++) {
				t = ((j<10)?"0":"")+j+":00";
			...
			objContent += "</select><input type='text' class='form-control input-sm ' name='cls_content[]' placeholder='주제'></div></div></div>";
		}
		if (delete_code) {
			objContent += delete_code;
		} else {
			<?php if ($is_file_content) { ?>
			objContent += "<div class='col-sm-5'><div class='form-group'><input type='text'name='cls_content[]' class='form-control input-sm' placeholder='주제'></div></div>";
			<?php } ?>
			;
		}
		objContent += "</div>";
...
<?php if ($is_file) { ?>
	<div class="form-group">
		<label class="col-sm-2 control-label hidden-xs">강의소개용 첨부파일</label>
		<div class="col-sm-10">
			<p class="form-control-static text-muted" style="padding:0px; padding-top:4px;">
