...
<section class="container background" >
	...
	<div class="page-title">모임 등록</div>
...
<?php // 온오프라인 ?>
			<div class="wr-list">
				...
				<div class="wr-list-con">
					<label class="radio-wrap"><input type="radio" name="moa_onoff" id="moa_onoff" value="온라인" <?php if ($write['moa_onoff'] == '온라인' || !$write['moa_onoff']) {echo " checked ";} ?>><span></span>온라인</label>
					<label class="radio-wrap"><input type="radio" name="moa_onoff" value="오프라인" <?php if ($write['moa_onoff'] == '오프라인') {echo " checked ";} ?>><span></span>오프라인</label>
				</div>
			</div>
<?php //} ?>
	...
	function add_class_item(delete_code,values) {
		...
		*/
		...
		if (values) 
			...
			objContent += "<div class='col-sm-10'><div class='form-group col-sm-10'><div class='input-group input-group-sm  col-sm-5' ><select name='cls_type[]' class=' input-small'style='display:none;'><option value='0' seleted>본모임 </option><option value='1'>보조모임</option></select><input type='text' class=' input-small cls_date' name='cls_day[]' placeholder='모임일자 '>&nbsp;:&nbsp;<select class=' input-small' name='cls_time[]' placeholder='모임시간 '>";
			var t = "";
			for (var j = 8; j < 20;j++) {
				t = ((j<10)?"0":"")+j+":00";
...
<?php // 진행시간 ?>
			<div class="wr-list flex-top">
				<div class="wr-list-label required">모임진행시간</div>
				<div class="wr-list-con">
					<input type="text" name="moa_totime" id="moa_totime" value="<?php echo $write['moa_totime']; ?>" class="  " size="50" style="width:100px;">&nbsp;분
				</div>
			</div>
<?php //} ?>

			<div class="wr-list flex-top">
				<div class="wr-list-label required">모임제목</div>
				<div class="wr-list-con">
					<input type="text" name="wr_subject" value="<?php echo $subject ?>" class="span500" placeholder="모임 제목을 입력하세요." size="50" maxlength="255">
				</div>
			</div>

			<div class="wr-list flex-top">
				<div class="wr-list-label required">모임내용</div>
				<div class="wr-list-con">
...
<?php if ($is_category || $option) { ?>
			<div class="wr-list flex-top">
				<div class="wr-list-label required"><?php echo ($is_category) ? '카테고리 설정' : '옵션';?></div>
				<div class="wr-list-con">
					<select name="ca_name" id="ca_name" required class="form-control input-sm" style="line-height:20px;height:30px;padding-top:0;">
...
?>
			...
			<div class="wr-list flex-top">
				<div class="wr-list-label required">모임유형</div>
				<div class="wr-list-con">
					<?php
					foreach($moatypeOff as $key => $value) {?>
						<label class="radio-wrap" for="moa_type<?php echo $cnt;?>" <?php if ($write['moa_type']==$value) { echo " checked ";} ?>>
						<input type="radio" name="moa_type" id="moa_type<?php echo $cnt;?>">
						<span></span><?php echo $value; ?></label>
					&nbsp;&nbsp;
					<?php 
						$cnt++;
					} 
...
<?php if ($is_file) { ?>
	...
	<div class="wr-list flex-top">
		<div class="wr-list-label required">모임 이미지</div>
		<div class="wr-list-con">
...
<?php } ?>
			...
			<div class="wr-list flex-top" style="display:none;">
		...
		<div class="write-btn pull-center">
			...
			<button type="submit" id="btn_submit" accesskey="s" class="btn btn-<?php echo $btn2;?> btn-sm" style="background:#D0D94E;border:0;width:100px;"><i class="fa fa-check"></i> <b style="color:#000;">다음</b></button>
		</div>
		</form>
...
<div class="write-btn pull-center" style="display:none;">
