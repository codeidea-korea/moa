...
<?php // 온오프라인 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="moa_onoff">모임형태</label>
		<div class="col-sm-10">
	...
	function add_class_item(delete_code,values) {
		...
		*/
		...
		if (values) 
			...
			objContent += "<div class='col-sm-10'><div class='form-group col-sm-10'><div class='input-group input-group-sm  '><select name='cls_type[]' class=' input-small' style='display:none;'><option value='0' selected>본모임 </option><option value='1'>보조모임</option></select><input type='text' class=' input-small cls_date' name='cls_day[]' placeholder='모임일자 '>&nbsp;:&nbsp;&nbsp;<select class=' input-small' name='cls_time[]' placeholder='모임시간 ' style='padding-left:5px;'>";
			var t = "";
			for (var j = 8; j < 20;j++) {
				t = ((j<10)?"0":"")+j+":00";
...
<?php if ($is_category || $option) { ?>
	<div class="form-group">
		<label class="col-sm-2 control-label hidden-xs"><?php echo ($is_category) ? '카테고리 설정' : '옵션';?></label>
		<?php if ($is_category) { ?>
			<div class="col-sm-3" >
...
?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="moa_type">모임타입</label>
		<div class="col-sm-10 online lounchecL radio" style="padding-top:1px">
			<?php
			$cnt = 1;
			foreach($moatypeOn as $key => $value) {?>
				<input type="radio" name="moa_type" value="<?= $value ?>" id="moa_type<?php echo $cnt;?>">
...
<div class="form-group">
	...
	<div class="col-sm-10" style="width:530px;">
...
<?php // 포함사항 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="moa_support">모임포함사항</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-10">
...
<?php // 불포함사항 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="moa_nosupport">모임불포함사항</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-10">
...
<?php // 준비물 ?>
	<div class="form-group" style=";">
		<label class="col-sm-2 control-label" for="moa_supplies">준비물</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-10">
...
<?php //if($is_use_tag) { //태그 ?>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="as_tag">키워드(해시태그)</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-10">
