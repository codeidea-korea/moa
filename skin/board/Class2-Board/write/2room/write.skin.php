...
$( document ).ready(function() {
    $('#header_write_complete').removeClass('dp_none');
	$('#wr_content').attr('placeholder','글을 작성해 주세요.')
});
</script>
...
<section class="s_content">
    <div class="com_write">
        <ul>
            ...
            <li>
                <div class="info_ent">
                    <input name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control input-sm" type="text" placeholder="제목">
                </div>
            </li>
            <li>
