...
if (defined('G5_IS_ADMIN')) {
    ...
    //echo '<link rel="stylesheet" href="'.ADMIN_SKIN_URL.'/css/new-admin.css">'.PHP_EOL;
    //echo '<link rel="stylesheet" href="'.ADMIN_SKIN_URL.'/css/new-adminDefault.css">'.PHP_EOL;
} else {
    $shop_css = '';
...
<script src="<?php echo G5_JS_URL ?>/jquery-3.4.1.slim.js"></script>
