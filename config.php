...
*/
define('G5_DOMAIN', 'https://www.moa-friends.com');
define('G5_HTTPS_DOMAIN', 'https://www.moa-friends.com:443');
...
if(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on') {   //https 통신일때 daum 주소 js
    ...
    define('G5_POSTCODE_JS', '<script src="https://dmaps.daum.net/map_js_init/postcode.v2.js"></script>');
}
?>