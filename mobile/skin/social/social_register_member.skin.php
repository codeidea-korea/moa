            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="mb_email" value="<?php echo isset($user_email) ? $user_email : ''; ?>" id="reg_mb_email" required <?php echo isset($user_email) ? 'readonly' : ''; ?> class="frm_input email required" maxlength="100" placeholder="이메일을 입력해주세요.">
                    ...
                    <tr>
                        ...
                        <td class="position_layout">
                            ...
                            <input type="text" onkeyup="$('#is_nick_search').val('')" name="mb_nick" id="reg_mb_nick" value="<?php echo isset($user_nick) ? get_text($user_nick) : ''; ?>" required class="form-input required nospace  half_input" size="10" maxlength="20" placeholder="닉네임">
