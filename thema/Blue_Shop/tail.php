	...
	<!--loader-->
		...
		<?php if($col_name) { ?>
			<?php if($col_name == "two") { ?>
					...
					<div class="col-md-<?php echo $col_side;?><?php echo ($at_set['side']) ? ' pull-left' : '';?> at-col at-side sideArea">
...
<?php
//add_stylesheet('<link rel="stylesheet" href="'.THEMA_URL.'/assets/js/jquery-toast/jquery.toast.css" type="text/css">',0);
?>
...
<script src="<?php echo THEMA_URL;?>/assets/js/animationEnigne.js?<?php echo time() ?>" ></script>
<script src="<?php echo THEMA_URL;?>/assets/js/easing.js?<?php echo time() ?>" ></script>
