		...
		<ul class="sidebar-list list-links">
			...
			<?php if($member['as_date']) { // 기간제 회원 ?>
				...
				<li>
					<a class="no-fa">
						<span class="pull-right">
							<?php echo ($member['push_key']) ? $member['push_key'] : '미등록' ;?>						
						</span>
						API KEY
					</a>		
				</li>
			...
			<li>
				<?php if ($member['response']) { ?>
					<a href="#" onclick="sidebar_open('sidebar-response'); return false;" class="no-fa">
						<span class="pull-right"><span class="label bg-skyblue en" style="border-radius: 50% !important;"><?php echo number_format($member['response']);?></span> 건</span>
				<?php } else { ?>
