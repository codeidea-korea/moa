...
?>
	<div class="owl-show">
		<div class="owl-container" style="background-color:#333;"><!--배경 background-image: url('http://aminablue.kr/data/apms/background/71d21e64b8a0b7da23f51b636e5418a8.jpg'); -->
			...
			?>
				<div class="item">
					<div class="item-list is-round-item" style="background-color:#fff;">
						...
						<div class="item-content" style="margin:0px;">
							<?php if($wset['star']) { ?>
								<div class="item-star">
							...
							<div class="item-details en">
								...
								<?php } ?>
								<?php if($list[$i]['it_point'] && $wset['point']) { ?>
