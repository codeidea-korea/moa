...
<div class="tbl_head01 tbl_wrap">
	...
	<?php for($i=1;$i<7;$i++){ ?>
	<tr>
		<td align="center">글제목<?php echo $i; ?></td>
		<td>
			<input type="text" name="wset[subject_<?php echo $i; ?>]" value="<?php echo $wset['subject_'.$i];?>" size="45" class="frm_input">
		</td>
	</tr>
	<tr>
		<td align="center">글제목<?php echo $i; ?></td>
	...
	<tr>
		...
		<td>
			<input type="text" name="wset[icon_<?php echo $i; ?>]" value="<?php echo ($wset['icon_'.$i]);?>" id="icon_<?php echo $i; ?>" size="20" class="frm_input">
