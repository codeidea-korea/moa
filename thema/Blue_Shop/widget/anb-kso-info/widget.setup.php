...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">글제목1</td>
		<td>
			<input type="text" name="wset[subject_1]" value="<?php echo $wset['subject_1'];?>" size="80" class="frm_input">
		</td>
	</tr>
	<tr>
		<td align="center">글제목2</td>
		<td>
			<input type="text" name="wset[subject_2]" value="<?php echo $wset['subject_2'];?>" size="80" class="frm_input">
		</td>
	</tr>
	<tr>
		<td align="center">이미지</td>
		<td>
			<input type="text" name="wset[img1]" value="<?php echo ($wset['img1']);?>" id="img1" size="36" class="frm_input">
			<a href="<?php echo G5_BBS_URL;?>/widget.image.php?fid=img1" class="btn_frmline win_scrap">이미지선택</a>
		</td>
	</tr>
	<tr>
		<td align="center">글제목3</td>
		<td>
			<input type="text" name="wset[subject_3]" value="<?php echo $wset['subject_3'];?>" size="80" class="frm_input">
		</td>
	</tr>
	</tbody>
	</table>
