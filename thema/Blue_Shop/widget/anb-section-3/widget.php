...
add_stylesheet('<link rel="stylesheet" href="'.$widget_url.'/widget.css?123" media="screen">', 0);
...
?>
<style>
	#<?php echo $widget_id;?> { padding:50px 0; }
	...
	#<?php echo $widget_id;?> .item-list { margin-right:<?php echo $gap;?>px; border: 1px solid #ddd; overflow: hidden; }
...
<div id="<?php echo $widget_id;?>" class="anb-section-3">
	<?php
