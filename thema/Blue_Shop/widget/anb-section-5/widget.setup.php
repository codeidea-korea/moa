...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">구글맵(iframe)</td>
		<td>
			<textarea type="text" name="wset[gmap]" style="height:130px;"><?php echo $wset['gmap'];?></textarea>
		</td>
	</tr>
	<tr>
		<td align="center">구글맵(iframe)</td>
		<td>
			<a href="https://www.google.co.kr/maps/" target="_blank">https://www.google.co.kr/maps/</a><br><br>
			주소검색후 -> 공유 -> 퍼가기 iframe 주소붙여넣기
		</td>
	</tr>
	</tbody>
	</table>
