...
add_stylesheet('<link rel="stylesheet" href="'.$widget_url.'/widget.css?1">', 0);
...
<style>
#section-7 { color: #000; }
#section-7 .triangle { border-top-color: <?php echo $wset['color_t'];?>; }
#section-7 .triangle i { position: absolute; top: -40px; left: 50%; margin-left: -13px; font-size: 30px; color: <?php echo $wset['color_tb'];?>; }
</style>
...
<section id="section-7" class="section-7">
	...
	<?php } ?>
	<div class="gallery-block content content-center" id="gallery">
		<div class="container" >
			<h2 class="margin-bottom-50" style="margin-bottom:50px";><?php echo $wset['title1'];?> <strong><?php echo $wset['title2'];?></strong></h2>
		</div>

		<div id="<?php echo $widget_id;?>" class="anb-section-7 <?php echo $css;?>">
			<?php
