...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">타이틀1</td>
		<td>
			<input type="text" name="wset[title1]" value="<?php echo $wset['title1'];?>" size="40" class="frm_input">
		</td>
	</tr>
	<tr>
		<td align="center">타이틀2</td>
		<td>
			<input type="text" name="wset[title2]" value="<?php echo $wset['title2'];?>" size="40" class="frm_input">
		</td>
	</tr>
	<tr>
