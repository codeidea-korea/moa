...
<style>
.head-shop-icon .cart a { display: block; background-image: url(<?php echo COLORSET_URL;?>/img/anb_sprite_v3.png); /*line-height: 500px;*/ overflow: hidden; }
.cart a { width: 33px;height:30px;background-position: 0 -90px; cursor: pointer; }
.cart { width: 48px;float:right; }
.head-shop-icon .my_page a { display: block; background-image: url(<?php echo COLORSET_URL;?>/img/anb_sprite_v3.png); /*line-height: 500px;*/ overflow: hidden; }
...
<div id="thema_wrapper wrap" class="wrapper <?php echo $is_thema_layout;?> <?php echo $is_thema_font;?>">
		...
		<div class="at-container">
			...
			<div class="header-item header-shop">
				<div class="shop-icon head-shop-icon">
					<div class="cart">
						<a href="<?php echo G5_SHOP_URL;?>/cart.php" data-original-title="<nobr>카트</nobr>" data-toggle="tooltip" data-placement="top" data-html="true" ></a>
					</div>
					<div class="my_page">
						<a href="<?php echo $at_href['login'];?>" onclick="sidebar_open('sidebar-user'); return false;" data-original-title="<nobr>마이페이지</nobr>" data-toggle="tooltip" data-placement="top" data-html="true" ></a>
					</div>
					<!--
			...
			<div id="menu-all" class="collapse">
				<div class="at-container table-responsive">
					...
					<div class="menu-all-btn">
						<div class="btn-group">
							<a class="btn btn-lightgray" href="<?php echo $at_href['main'];?>"><i class="fa fa-home blue"></i></a>
		...
		<?php if($col_name) { ?>
			...
			<?php if($col_name == "two") { ?>
				<div class="row at-row">
					<div class="col-md-<?php echo $col_content;?><?php echo ($at_set['side']) ? ' pull-right' : '';?> at-col at-main shop-colorset">
			<?php } else { ?>
