...
<div class="at-container widget-index">
	...
	<div class="hidden-xs hidden-md">
		<?php echo apms_widget('anb-title', $wid.'-wt1', 'height=320px', 'auto=0'); //타이틀 ?>
	</div>
	<!--Mobile-->
			...
			<div class="main-box">
				...
				<div class="div-title-underbar">
					<a href="<?php echo $at_href['event'];?>">
						...
						<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?> main-title-color">
							<b>Event</b>
						</span>
					</a>
				</div>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
								<b class="main-title-color">Bank Info</b>
							</span>
						</div>
						<div class="widget-box">
