...
<style>
	...
	.main-title-color { color: #3a9ceb; }
	.img-wrap .img-item { border-radius: 5px; }
</style>

<!--PC-->
<div class="hidden-xs hidden-md">
	<?php echo apms_widget('anb-title', $wid.'-wt1', 'shadow=4 height=400px', 'auto=0'); //타이틀 ?>
</div>
<!--Mobile-->
<div class="visible-xs visible-md">
	<?php echo apms_widget('basic-title', $wid.'-wt2', 'shadow=4 height=400px', 'auto=0'); //타이틀 ?>
</div>
	...
	<div class="row at-row">
			...
			<div class="main-box">
				...
				<h2 class="div-title-underbar">
					<a href="<?php echo $at_href['itype'];?>?type=1">
						...
						<span class="div-title-underbar-bold border-<?php echo $line;?> main-title-color">
							Hit & Best
						</span>
					</a>
				</h2>
		...
		<div class="col-md-3<?php echo ($side == "left") ? ' pull-left' : '';?> at-col at-side">
					...
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
								<b class="main-title-color"><?php echo ($is_member) ? 'Profile' : 'Login';?></b>
							</span>
						</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-6">
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
								<b class="main-title-color">Service</b>
							</span>
						</div>
					...
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<a href="<?php echo $at_href['event'];?>">
								...
								<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
									<b class="main-title-color">Event</b>
								</span>
							</a>
						</div>
						<div class="widget-box">
					...
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=basic">
								<span class="pull-right lightgray <?php echo $font;?>">+</span>
								<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
									<b class="main-title-color">Notice</b>
								</span>
							</a>
						</div>
						<div class="widget-box">
				...
				<div class="col-md-12 col-sm-6">
					...
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<a href="<?php echo $at_href['iuse'];?>">
								<span class="pull-right lightgray <?php echo $font;?>">+</span>
								<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
									<b class="main-title-color">Review</b>
								</span>
							</a>
						</div>
						<div class="widget-box">
					...
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<a href="<?php echo $at_href['iqa'];?>">
								<span class="pull-right lightgray <?php echo $font;?>">+</span>
								<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
									<b class="main-title-color">Q & A</b>
								</span>
							</a>
						</div>
						<div class="widget-box">
					...
					<div class="main-box">
						...
						<div class="div-title-underbar">
							<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
								<b class="main-title-color">Comment</b>
							</span>
						</div>
						<div class="widget-box">
			...
			<div class="main-box">
				...
				<div class="div-title-underbar">
					<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
						<b class="main-title-color">Banner</b>
					</span>
				</div>
				<div class="widget-box">
			...
			<div class="main-box">
				...
				<div class="div-title-underbar">
					<a href="<?php echo $at_href['secret'];?>">
						<span class="pull-right lightgray <?php echo $font;?>">+</span>
						<span class="div-title-underbar-bold border-<?php echo $line;?> <?php echo $font;?>">
							<b class="main-title-color">CS Center</b>
						</span>
					</a>
				</div>
				<div class="widget-box">
