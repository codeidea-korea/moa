...
if($shop) { //쇼핑몰
	...
	//$shmenu[]['m'] = array('anb-shop-onepage', '샵 원페이지', '', 0);
	...
	$hmenu[$i]['href'] = $demo_href.urlencode('basic-main');
	//$shmenu[]['m'] = array('anb-main-compy', '컴파니 원페이지', '', 0);
	$shmenu[]['m'] = array('anb-main-bbs', '커뮤니티 베이직 라지', '', 0);
	$shmenu[]['m'] = array('anb-main-commuity', '커뮤니티 베이직', '', 0);
...
// 파일설정
if($mon != 'main') {
	$at_set['mfile'] = ($shop) ? 'basic-shop-main' : 'anb-main-bbs';//'basic-main';
