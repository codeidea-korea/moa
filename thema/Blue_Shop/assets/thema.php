...
$page_list = array(
	...
	"hid"		=> "anb-main-compy,anb-main-commuity,anb-main-bbs,anb-shop-main"
);
...
if($col_name == 'two') {
	...
	if($bo_table == 'property' && $wr_id && $w != 'u' ) { //특정게시판에 뷰페이지만
		echo $is_side_file = THEMA_PATH.'/side/sidebar_property.php';
	}
}
