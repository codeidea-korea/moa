...
$query1 = "select si.*, wc.as_thumb from g5_shop_item as si join g5_write_class as wc on si.it_2 = wc.wr_id where si.pt_plan = 1 and wc.moa_status = 1 order by wc.wr_id";
$result = sql_query($query1);
include_once(MOA_MAIN_SKIN."/exhibitions.skin.php");
$query2 = "select si.*, wc.as_thumb from g5_shop_item as si join g5_write_class as wc on si.it_2 = wc.wr_id where si.pt_pick = 1 and wc.moa_status = 1 order by wc.wr_id";
