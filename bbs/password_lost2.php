...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
	<div style="border:1px solid #dedede">
		...
		<p style="margin:20px 0 0;padding:30px 30px 30px;border-bottom:1px solid #eee;line-height:1.7em">
			'.addslashes($mb['mb_name']).'('.addslashes($mb['mb_nick']).') 회원님은' . G5_TIME_YMDHIS . '에 회원정보 찾기 요청을 하셨습니다.<br>
...
sendDirectMail($subject, $body, $config['cf_admin_email'], $config['cf_admin_email_name'], $receiver, 0, 'NORMAL');
