...
$sql_common = " from {$g5['g5_shop_item_table']} a ,
               ...
               where  a.ca_id like '10%' and (a.ca_id = b.ca_id";
if ($is_admin != 'super')
...
<select name="sfl" id="sfl">
    ...
    <option value="it_id" <?php echo get_selected($sfl, 'it_id'); ?>>강의코드</option>
...
<form name="fitemlec_listupdate" method="post" action="./itemlec_listupdate.php" onsubmit="return fitemlec_list_submit(this);" autocomplete="off" id="fitemlec_listupdate">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" ><?php echo subject_sort_link('it_id', 'sca='.$sca); ?>강의코드</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_pc_title"  class="td_input">
            <label for="name_<?php echo $i; ?>" class="sound_only">강의명</label>
        ...
        <td  class="td_mng td_mng_s">
            <a href="./itemlec_form.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03"><span class="sound_only"><?php echo htmlspecialchars2(cut_str($row['it_name'],250, "")); ?> </span>수정</a>
            <!--
...
<div class="btn_fixed_top">
    ...
    <a href="./itemlec_form.php" class="btn btn_01">강의등록</a>
    <?php /*
    <a href="./itemexcel.php" onclick="return excelform(this.href);" target="_blank" class="btn btn_02">강의일괄등록</a>
...
<script>
function fitemlec_list_submit(f)
{
    if (!is_checked("chk[]")) {
