...
$sql_common = " from {$g5['mainvod_table']} ";
...
<form name="fmemberlist" id="fmemberlist" action="./mainvod_list_update.php" onsubmit="return fmainvodlist_submit(this);" method="post">
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        if ($is_admin == 'group') {
            ...
            $s_mod = '<a href="./mainvod_form.php?'.$qstr.'&amp;w=u&amp;mv_no='.$row['mv_no'].'" class="btn btn_03">수정</a>';
        }
...
function fmainvodlist_submit(f)
{
    if (!is_checked("chk[]")) {
...
<div class="btn_fixed_top">
    ...
    <a href="./mainvod_form.php" id="member_add" class="btn btn_01">VOD추가</a>
    <?php } ?>
