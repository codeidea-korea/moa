	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            ...
            <td style="border-top:0;">
				<label><input type="checkbox" name="apms_partner" value="1" id="apms_partner"<?php echo $apms['apms_partner'] ? ' checked' : ''; ?>> 호스트</label>
				&nbsp; &nbsp;
		...
		<tr>
            ...
            <td style="border-top:0;">
				<label><input type="checkbox" name="apms_company" value="1" id="apms_company"<?php echo $apms['apms_company'] ? ' checked' : ''; ?>> 기업 호스트</label>
				&nbsp; &nbsp;
				<label><input type="checkbox" name="apms_personal" value="1" id="apms_personal"<?php echo $apms['apms_personal'] ? ' checked' : ''; ?>> 개인 호스트</label>
			</td>
		</tr>
		<tr>
