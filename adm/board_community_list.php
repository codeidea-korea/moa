...
<div class="tbl-basic odd line-nth-1 outline th-h6 td-h5 fs14">
	
	<div class="tbl-header">
		<div class="right">
			<span class="btn small reverse add-cummunity">+ 커뮤니티 내 제목 추가</span>
		</div>
	</div>
    ...
    <tr>
		...
		<th scope="col">공개</th>
		<th scope="col">순위 조정</th>
		<th scope="col">개시물 수(개)</th>
		<th scope="col">생성일</th>
        ...
        <th scope="col" class="none"><?php echo subject_sort_link('a.gr_id') ?>그룹</a></th>
        <th scope="col" class="none"><?php echo subject_sort_link('bo_table') ?>TABLE</a></th>        
		<th scope="col" class="none"><?php echo subject_sort_link('bo_skin', '', 'desc') ?>PC<br>스킨</a></th>
        <th scope="col" class="none"><?php echo subject_sort_link('bo_mobile_skin', '', 'desc') ?>모바일<br>스킨</span></a></th>
    ...
    <tr>
		...
		<td class=""><?php echo get_text($row['bo_subject']) ?></td>
		<td class=""><span class="color-blue">공개</span></td>
		<td class="">
...
<div id="cummunity-add-from" style="display:none">
...
<script>
$('.btn.add-cummunity').click(function(){
	$('#cummunity-add-from').show();
});
</script>
