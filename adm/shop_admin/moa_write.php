...
$board_skin_url = G5_URL."/shop/partner/skin/Class-Board";
$board_skin_path = G5_PATH."/shop/partner/skin/Class-Board";

// echo "<BR><br><br><div style='margin-left:300px;width:700px'>";
// echo 'board_skin_url : '.$board_skin_url."<BR>";
...
//$action_url = https_url(G5_SHOP_URL)."/partner/write_update.php";
