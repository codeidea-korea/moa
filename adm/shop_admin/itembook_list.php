...
$sql_common = " from {$g5['g5_shop_item_table']} a ,
               ...
               where  a.ca_id like '20%' and (a.ca_id = b.ca_id";
if ($is_admin != 'super')
...
<div class="local_ov01 local_ov">
    <?php echo $listall; ?>
    <span class="btn_ov01"><span class="ov_txt">등록된 도서</span><span class="ov_num"> <?php echo $total_count; ?>건</span></span>
</div>
...
<select name="sca" id="sca">
    ...
    <?php
    $sql1 = " select ca_id, ca_name from {$g5['g5_shop_category_table']} where ca_id like '20%' order by ca_order, ca_id ";
...
<select name="sfl" id="sfl">
    <option value="it_name" <?php echo get_selected($sfl, 'it_name'); ?>>도서명</option>
    <option value="it_id" <?php echo get_selected($sfl, 'it_id'); ?>>도서코드</option>
...
<form name="fitembook_listupdate" method="post" action="./itembook_listupdate.php" onsubmit="return fitembook_list_submit(this);" autocomplete="off" id="fitembook_listupdate">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        <th scope="col" >
            <label for="chkall" class="sound_only">도서 전체</label>
            <input type="checkbox" name="chkall" value="1" id="chkall" onclick="check_all(this.form)">
        </th>
        <th scope="col" ><?php echo subject_sort_link('it_id', 'sca='.$sca); ?>도서코드</a></th>
        ...
        <th scope="col"  id="th_category">카테고리</th>
        <th scope="col"  id="th_pc_title"><?php echo subject_sort_link('it_name', 'sca='.$sca); ?>상품명</a></th>
        <th scope="col" id="th_camt"><?php echo subject_sort_link('it_cust_price', 'sca='.$sca); ?>정상금액</a></th>
        <th scope="col" id="th_amt"><?php echo subject_sort_link('it_price', 'sca='.$sca); ?>할인금액</a></th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_pc_title"  class="td_input">
            <label for="name_<?php echo $i; ?>" class="sound_only">도서명</label>
        ...
        <td  class="td_mng td_mng_s">
            <a href="./itembook_form.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03"><span class="sound_only"><?php echo htmlspecialchars2(cut_str($row['it_name'],250, "")); ?> </span>수정</a>
            <!--
...
<div class="btn_fixed_top">
    ...
    <a href="./itembook_form.php" class="btn btn_01">도서등록</a>
    <?php /*
    <a href="./itemexcel.php" onclick="return excelform(this.href);" target="_blank" class="btn btn_02">도서일괄등록</a>
...
<script>
function fitembook_list_submit(f)
{
    if (!is_checked("chk[]")) {
