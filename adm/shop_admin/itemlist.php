...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="3"><?php echo subject_sort_link('it_id', 'sca='.$sca); ?>모임코드</a></th>
        <th scope="col" colspan="8">분류</th>
        <th scope="col" rowspan="3"><?php echo subject_sort_link('pt_main', 'sca='.$sca); ?>메인</a></th>
		<th scope="col" rowspan="3"><?php echo subject_sort_link('pt_plan', 'sca='.$sca); ?>기획전</a></th>
		<th scope="col" rowspan="3"><?php echo subject_sort_link('pt_pick', 'sca='.$sca); ?>모아pick</a></th>
		<!-- <th scope="col" rowspan="3"><?php echo subject_sort_link('it_order', 'sca='.$sca); ?>순서</a></th> -->
        <th scope="col" rowspan="3"><?php echo subject_sort_link('it_use', 'sca='.$sca, 1); ?>신청가능</a></th>
        <th scope="col" rowspan="3"><?php echo subject_sort_link('it_soldout', 'sca='.$sca, 1); ?>정원초과</a></th>
    ...
    <tr>
        ...
        <th scope="col" rowspan="2" id="th_pc_title"><?php echo subject_sort_link('it_name', 'sca='.$sca); ?>모임명</a></th>
		...
		<!-- APMS - 2014.07.20 -->
	        ...
	        <th scope="col" id="th_type">모임종류</a></th>
		<!-- // -->
    </tr>
    <tr>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td rowspan="3" class="td_mngsmall">
            <label for="main_<?php echo $i; ?>" class="sound_only">메인모임</label>
            <input type="checkbox" name="pt_main[<?php echo $i; ?>]" <?php echo ($row['pt_main'] ? 'checked' : ''); ?> value="1" id="main_<?php echo $i; ?>">
        </td>
		<td rowspan="3" class="td_mngsmall">
            <label for="main_<?php echo $i; ?>" class="sound_only">기획전</label>
            <input type="checkbox" name="pt_plan[<?php echo $i; ?>]" <?php echo ($row['pt_plan'] ? 'checked' : ''); ?> value="1" id="main_<?php echo $i; ?>">
        </td>
		<td rowspan="3" class="td_mngsmall">
            <label for="main_<?php echo $i; ?>" class="sound_only">모아pick</label>
            <input type="checkbox" name="pt_pick[<?php echo $i; ?>]" <?php echo ($row['pt_pick'] ? 'checked' : ''); ?> value="1" id="main_<?php echo $i; ?>">
        </td>
		<!-- <td rowspan="3" class="td_mngsmall">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_pc_title" rowspan="2" class="td_input td_left">
			<?php echo help("모임등록폼 : ".apms_form_option('name', $flist, $row['pt_form']));?>
...
<div class="btn_fixed_top">
    <a href="./itemform.php" class="btn btn_01">모임등록</a>
