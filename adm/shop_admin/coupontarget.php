...
<div id="sch_target_frm" class="new_win scp_new_win">
    ...
    <div class="tbl_head01 tbl_wrap new_win_con">
        ...
        <tr>
            ...
            <td class="td_mng td_mng_s"><button type="button" class="btn btn_03" onclick="sel_target_id('<?php echo $row['t_id']; ?>');" style="background:#d0db23 !important;color:#000 !important;border-radius:3px;">선택</button>
        </tr>
        <?php
        }
