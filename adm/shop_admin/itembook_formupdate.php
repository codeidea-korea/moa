...
<script>
    if (confirm("계속 입력하시겠습니까?"))
        //location.href = "<?php echo "./itembook_form.php?it_id=$it_id&amp;sort1=$sort1&amp;sort2=$sort2&amp;sel_ca_id=$sel_ca_id&amp;sel_field=$sel_field&amp;search=$search&amp;page=$page"?>";
        location.href = "<?php echo "./itembook_form.php?".str_replace('&amp;', '&', $qstr); ?>";
    else
        location.href = "<?php echo "./itembook_list.php?".str_replace('&amp;', '&', $qstr); ?>";
</script>
