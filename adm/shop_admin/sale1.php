...
<div class="local_sch03 local_sch">
    ...
    <div>
        <form name="frm_sale_today" action="./sale1today.php" target="frmSale"  method="get">
        <input type="hidden" name="inner" value="none">
        <strong>일일 매출</strong>
    ...
    <div>
        <form name="frm_sale_date" action="./sale1date.php" target="frmSale"  method="get">
        <input type="hidden" name="inner" value="none">
        <strong>일간 매출</strong>
    ...
    <div>
        <form name="frm_sale_month" action="./sale1month.php" target="frmSale" method="get">
        <input type="hidden" name="inner" value="none">
        <strong>월간 매출</strong>
    ...
    <div class="sch_last">
        <form name="frm_sale_year" action="./sale1year.php" target="frmSale"  method="get">
        <input type="hidden" name="inner" value="none">
        <strong>연간 매출</strong>
...
<iframe name="frmSale" style="width:100%;height:800px;border:1px"></iframe>
<?php
