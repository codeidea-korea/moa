...
if ($bn_bimg_del)  @unlink(G5_DATA_PATH."/banner");
...
{
    @unlink(G5_DATA_PATH."/banner/$bn_bimg_name");
...
if ($w == "" || $w == "u")
{
    if ($bn_bimg_name) move_uploaded_file($_FILES['bn_bimg']['tmp_name'], G5_DATA_PATH."/banner/".$bn_bimg_name);
