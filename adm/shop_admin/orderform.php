...
<li><a href="#anc_sodr_list">신청 목록</a></li>
<li><a href="#anc_sodr_pay">신청결제 내역</a></li>
<li><a href="#anc_sodr_chk">결제상세정보 확인</a></li>
<li><a href="#anc_sodr_paymo">결제상세정보 수정</a></li>
<li><a href="#anc_sodr_memo">호스트메모</a></li>
<li><a href="#anc_sodr_orderer">신청하신 분</a></li>
</ul>';
...
<section id="anc_sodr_list">
    <h2 class="h2_frm">신청 목록</h2>
    <?php // echo $pg_anchor; ?>
    <div class="local_desc02 local_desc">
        <p>
            현재 신청상태 <strong><?php echo $od['od_status'] ?></strong>
            |
            신청일시 <strong><?php echo substr($od['od_time'],0,16); ?> (<?php echo get_yoil($od['od_time']); ?>)</strong>
            |
            신청총액 <strong><?php echo number_format($od['od_cart_price'] + $od['od_send_cost'] + $od['od_send_cost2']); ?></strong>원
        </p>
    ...
    <div class="tbl-basic fs13 outline odd line-nth-1">
        ...
        <tr>
			...
			<th scope="col">상품명</th>
            <th scope="col">
                <label for="sit_select_all" class="sound_only">신청 상품 전체</label>
    ...
    <div class="local_desc01 local_desc">
        <!-- <p>입금, 완료는 장바구니와 신청서 상태를 모두 변경하지만, 취소, 반품, 품절은 장바구니의 상태만 변경하며, 신청서 상태는 변경하지 않습니다.</p> -->
        <p>개별적인(이곳에서의) 상태 변경은 모든 작업을 수동으로 처리합니다. 예를 들어 입금에서 완료으로 상태 변경시 입금액(결제금액)을 포함한 모든 정보는 수동 입력으로 처리하셔야 합니다.</p>
    </div>
...
<?php if($od['od_test']) { ?>
<div class="od_test_caution">주의) 이 신청은 테스트용으로 실제 결제가 이루어지지 않았으므로 절대 배송하시면 안됩니다.</div>
<?php } ?>
<?php if($od['od_pg'] === 'inicis' && !$od['od_test']) {
    ...
    if($tmp_row['P_TID']){
?>
<div class="od_test_caution">주의) 이 신청은 결제취소된 내역이 있습니다. 이니시스 관리자 호스트에서 반드시 재확인을 해 주세요.</div>
<?php 
    }   //end if
}   //end if
?>
...
<section id="anc_sodr_pay">
    ...
    <div class="tbl-basic fs13 outline odd line-nth-1">
        ...
        <table>
        <caption>신청결제 내역</caption>
        <thead>
        <tr>
            <th scope="col">신청번호</th>
            <th scope="col">결제방법</th>
            <th scope="col">신청총액</th>
            <!-- <th scope="col">배송비</th> -->
...
<section class="">
            ...
            <div class="tbl-basic fs13 outline odd line-nth-1">
                ...
                <?php if ($config['cf_email_use']) { ?>
					<tr>
						...
						<td>
							<?php echo help("신청자님께 입금, 배송내역을 메일로 발송합니다.\n메일발송시 호스트메모에 기록됩니다."); ?>
					...
					?>
						<tr>
							<th scope="row"><label for="pt_send_mail">신청알림</label></th>
							<td>
								<?php echo help("호스트에게 결제, 신청내역을 메일로 발송합니다."); ?>
								...
								<?php } ?>
						        <textarea name="pt_email_memo" id="pt_email_memo" rows="4" placeholder="호스트 전달사항" style="height:80px;"></textarea>
							</td>
						</tr>
					<?php } ?>
				<?php } ?>
    ...
    <div class="btn_confirm01 btn_confirm">
        <input type="submit" value="결제내역 수정" class="btn_submit btn">
        <?php if($od['od_status'] == '신청' && $od['od_misu'] > 0) { ?>
...
<section id="anc_sodr_memo">
    <h2 class="h2_frm">호스트메모</h2>
    <?php // echo $pg_anchor; ?>
    <div class="local_desc02 local_desc">
        <p>
            현재 열람 중인 신청에 대한 내용을 메모하는곳입니다.<br>
    ...
    <div class="tbl_wrap">
        <label for="od_shop_memo" class="sound_only">호스트메모</label>
...
<section class="none">
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_orderer" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    <th scope="row"><label for="od_email"><span class="sound_only">신청하신 분 </span>E-mail</label></th>
                ...
                <tr>
                    <th scope="row"><span class="sound_only">신청하신 분 </span>IP Address</th>
        ...
        <section id="anc_sodr_taker" class="compare_right none">
            <h3>받으시는 분</h3>
    ...
    <div class="btn_confirm01 btn_confirm">
        <input type="submit" value="신청자 정보 수정" class="btn_submit btn ">
