...
<section class="container background">
	...
	<div class="boxContainer write" style="max-width:1250px;">
		...
		<div class="wr-wrap label180">
			<div class="wr-list flex-top">
				<div class="wr-list-label">채크박스(버튼)</div>
				<div class="wr-list-con">
					<div class="checkbox-group gap10">
						<label class="checkbox-wrap button"><input type="checkbox" name="" value="" checked><span>옵션A</span></label>
						<label class="checkbox-wrap button"><input type="checkbox" name="" value=""><span>옵션B</span></label>
						<label class="checkbox-wrap button"><input type="checkbox" name="" value=""><span>옵션C</span></label>
						<label class="checkbox-wrap button"><input type="checkbox" name="" value=""><span>옵션D</span></label>
						<label class="checkbox-wrap button"><input type="checkbox" name="" value=""><span>옵션E</span></label>
					</div>
				</div>
			</div>
			<div class="wr-list flex-top">
			...
			<div class="wr-list">
				...
				<div class="wr-list-con">					
					<input type="text" name="" value="" class="span160 datepicker" placeholder="날짜 선택">
				</div>
			</div>
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td class="bg">
										<input type="text" name="" value="" class="span90" maxlength="2" data-label-inline="분">
									</td>
									<td class="bg">
					...
					<div class="tbl-excel " id="moim">
						<table>
							...
							<tbody>
								<tr>
									<td class="bg">
										<label class="inp-wrap inline-label"><input type="text" name="" value="" class="span" maxlength="2"><span class="label-inline">분</span></label>
									</td>
									<td class="bg">
							...
							<tfoot>
								<tr>
									<td colspan="2" class="bg">
										<span class="add-list span tcenter">+ 추가하기</span>
									</td>								
								</tr>								
							</tfoot>
						</table>
