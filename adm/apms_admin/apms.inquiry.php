...
$parter = get_partner($row['mb_id']);

$pp_phone = $partner['mb_hp'];
...
if($pinfo['mb_nick']) {
	$pp_name = $pinfo['mb_id']."<BR>".$pinfo['mb_nick']; //get_sideview($row['mb_id'], $pinfo['mb_nick'], $pinfo['mb_email'], $pinfo['wr_homepage']);
...
<div class="tbl-basic outline th-h5 fs15 odd line-nth-2">
    ...
    <div class="tbl_head02 tbl_wrap">
		...
		<?php } ?>
		<!-- <tr>
            <td align="center">휴대전화</td><td><?php echo $pp_phone; ?></td>
        </tr> -->
		<tr>
	...
	<div class="btn_confirm01 btn_confirm" style="text-align:center">
		<button class="btn " accesskey="s" type="submit">저장</button>
    ...
    <h2>계정현황 : <?php echo date("Y년 m월 d일 H시 i분", G5_SERVER_TIME);?> 기준</h2>
