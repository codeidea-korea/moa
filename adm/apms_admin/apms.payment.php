...
<div class="data-search-wrap fx-wrap label120">
	...
	<div class="fx-list">
		...
		<div class="fx-list-con">
			...
			<button type="button" class="btn reverse span80">초기화</button>
		</div>
	</div>
</div>
</form>
