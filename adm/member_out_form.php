...
<div class="tbl-excel tleft">
	...
	<tr>
        <td scope="row">성별</td>
        <td>
			<input type="radio" name="sex" value="" id="" checked data-label="남">
            <input type="radio" name="sex" value="" id="" data-label="여">
        </td>
    </tr>
	<tr>
        <td scope="row">생년월일</td>
        <td><input type="text" name="" value="" id="" class="span200"></td>
    </tr>
	<tr>
        <td scope="row">직장</td>
...
<div class="btn_fixed_top">
    <a href="./member_out_list.php?<?php echo $qstr ?>" class="btn btn_02">목록</a>
