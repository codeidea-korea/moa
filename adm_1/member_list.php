...
<section class="myContainer bg">
	...
	<div class="boxContainer padding40">
		...
		<div class="box-header">
			...
			<a href="./member_form.php" class="btn span110 gray">회원등록</a>
			<?php } ?>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td><a href="./member_view.php">1</a></td>
						<td>승인</td>
						<td>호스트</td>
						<td>직장인</td>
						<td><a href="./member_view.php">UserNum1</a></td>
						<td><a href="./member_view.php">Test1</a></td>
						<td>닉네임1</td>
						<td><a href="./member_view.php">김모임</a></td>
						<td>010-1234-5678</td>
					...
					<tr>
						<td><label class="checkbox-wrap"><input type="checkbox" name="" value=""  /><span></span></label></td>
						<td><a href="./member_view.php">2</td>
						<td>-</td>
						<td>게시트</td>
						<td>직장인</td>
						<td><a href="./member_view.php">UserNum2</a></td>
						<td><a href="./member_view.php">Test2</a></td>
						<td>닉네임2</td>
						<td><a href="./member_view.php">김모임</a></td>
						<td>010-1234-5678</td>
						<td>newmeon@naver.com</td>
					...
					<tr>
						<td><label class="checkbox-wrap"><input type="checkbox" name="" value=""  /><span></span></label></td>
						<td><a href="./member_view.php">3</td>
						<td>승인</td>
						<td>호스트</td>
						<td>프리랜서</td>
						<td><a href="./member_view.php">UserNum3</a></td>
						<td><a href="./member_view.php">Test3</a></td>
						<td>닉네임3</td>
						<td><a href="./member_view.php">김모임</a></td>
						<td>010-1234-5678</td>
						<td>newmeon@naver.com</td>
