...
<form name="fitemlec_form" action="./itemlec_formupdate.php" method="post" enctype="MULTIPART/FORM-DATA" autocomplete="off" onsubmit="return fitemlec_formcheck(this)">
...
<section id="anc_sitfrm_cate">
    <h2 class="h2_frm">강의카테고리</h2>
    <?php echo $pg_anchor; ?>
    <div class="local_desc02 local_desc">
        <p>기본카테고리는 반드시 선택하셔야 합니다. 하나의 강의에 최대 2개의 다른 카테고리를 지정할 수 있습니다.</p>
    </div>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>강의카테고리 입력</caption>
        <colgroup>
            <col class="grid_4">
            <col>
        </colgroup>
        ...
        <tr>
            ...
            <td>
                <?php echo help($i.'차 카테고리는 기본 카테고리의 하위 카테고리 개념이 아니므로 기본 카테고리 선택시 해당 강의이 포함될 최하위 카테고리만 선택하시면 됩니다.'); ?>
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                <?php if ($w == '') { // 추가 ?>
                    ...
                    <?php echo help("강의의 코드는 10자리 숫자로 자동생성합니다. <b>직접 강의코드를 입력할 수도 있습니다.</b>\n강의코드는 영문자, 숫자, - 만 입력 가능합니다."); ?>
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo G5_SHOP_URL; ?>/item.php?it_id=<?php echo $it_id; ?>" class="btn_frmline">강의확인</a>
                    <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">사용후기</a>
                    <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn_frmline">강의문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <?php echo help("메인화면에 유형별로 출력할때 사용합니다.\n이곳에 체크하게되면 강의리스트에서 유형별로 정렬할때 체크된 강의이 가장 먼저 출력됩니다."); ?>
                ...
                <label for="it_type3">신강의 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""></label>
        ...
        <tr>
            <th scope="row"><label for="it_name">강의상품명</label></th>
            <td colspan="2">
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 강의상세페이지에 출력하지 않습니다."); ?>
            ...
            <td>
                <?php echo help("입력하지 않으면 강의상품상세페이지에 출력하지 않습니다."); ?>
...
<tr style="display:">
            <th scope="row"><label for="it_origin">강의시간</label></th>
            <td>
        ...
        <tr>
            ...
            <td>
                <?php echo help("강의명 하단에 강의에 대한 추가적인 설명이 필요한 경우에 입력합니다. HTML 입력도 가능합니다."); ?>
        ...
        <tr style="display:none">
            ...
            <td>
                <?php echo help("강의 금액 대신 전화문의로 표시됩니다."); ?>
        ...
        <tr style="display:none">
            ...
            <td>
                <?php echo help("설정에 체크하시면 쿠폰 생성 때 강의 검색 결과에 노출되지 않습니다."); ?>
        ...
        <tr>
            ...
            <td>
                <?php echo help("운영자와 실제 판매자가 다른 경우 실제 판매자의 e-mail을 입력하면, 강의상품 주문 시점을 기준으로 실제 판매자에게도 주문서를 발송합니다."); ?>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr style="display:none">
            <th scope="row"><label for="it_soldout">강의상품품절</label></th>
            <td>
                <?php echo help("잠시 판매를 중단하거나 재고가 없을 경우에 체크해 놓으면 품절강의상품으로 표시됩니다."); ?>
        ...
        <tr style="display:none">
            ...
            <td colspan="2">
                <?php echo help("상품이 품절인 경우에 체크해 놓으면 강의상품상세보기에서 고객이 재입고SMS 알림을 신청할 수 있게 됩니다."); ?>
        ...
        <tr style="display:none">
            ...
            <td>
                <?php echo help("<b>주문관리에서 강의상품별 상태 변경에 따라 자동으로 재고를 가감합니다.</b> 재고는 규격/색상별이 아닌, 강의상품별로만 관리됩니다.<br>재고수량을 0으로 설정하시면 품절강의상품으로 표시됩니다."); ?>
        ...
        <tr style="display:none">
            ...
            <td>
                <?php echo help("강의상품의 재고가 통보수량보다 작을 때 쇼핑몰관리 메인화면의 재고현황에 재고부족 강의상품으로 표시됩니다.<br>옵션이 있는 강의상품은 개별 옵션의 통보수량이 적용됩니다."); ?>
        ...
        <tr style="display:none">
            ...
            <td>
                <?php echo help("강의상품 구매시 최소 구매 수량을 설정합니다."); ?>
        ...
        <tr >
            ...
            <td>
                <?php echo help("강의상품 구매시 최대 구매 수량을 설정합니다."); ?>
        ...
        <tr style="display:none">
            <th scope="row"><label for="it_notax">강의상품과세 유형</label></th>
            <td>
                <?php echo help("강의상품의 과세유형(과세, 비과세)을 설정합니다."); ?>
        ...
        ?>
        <tr>
            <th scope="row">강의상품추가옵션</th>
            <td colspan="2">
                <div id="sit_supply_frm" class="sit_option tbl_frm01">
                    <?php echo help('옵션항목은 콤마(,) 로 구분하여 여러개를 입력할 수 있습니다. 스마트폰을 예로 들어 [추가1 : 추가구성강의상품 , 추가1 항목 : 액정보호필름,케이스,충전기]<br><strong>옵션명과 옵션항목에 따옴표(\', ")는 입력할 수 없습니다.</strong>'); ?>
                    <table>
                    <caption>강의상품추가옵션 입력</caption>
                    <colgroup>
                        <col class="grid_4">
                        <col>
                    </colgroup>
...
<section id="anc_sitfrm_sendcost"  style="display:none">
    ...
    <?php echo $pg_anchor; ?>
    <div class="local_desc02 local_desc">
        <p>쇼핑몰설정 &gt; 배송비유형 설정보다 <strong>개별강의상품 배송비설정이 우선</strong> 적용됩니다.</p>
    </div>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
            ...
            <tr id="sc_con_qty">
                ...
                <td>
                    <?php echo help("강의상품의 주문 수량에 따라 배송비가 부과됩니다. 예를 들어 기본배송비가 3,000원 수량을 3으로 설정했을 경우 강의상품의 주문수량이 5개이면 6,000원 배송비가 부과됩니다."); ?>
...
<section id="anc_sitfrm_optional">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row">강의상품상단내용</th>
            <td><?php echo help("강의상품상세설명 페이지 상단에 출력하는 HTML 내용입니다."); ?><?php echo editor_html('it_head_html', get_text($it['it_head_html'], 0)); ?></td>
            <td class="td_grpset">
        ...
        <tr>
            <th scope="row">강의상품하단내용</th>
            <td><?php echo help("강의상품상세설명 페이지 하단에 출력하는 HTML 내용입니다."); ?><?php echo editor_html('it_tail_html', get_text($it['it_tail_html'], 0)); ?></td>
            <td class="td_grpset">
        ...
        <tr  style="display:none">
            <th scope="row">모바일 강의상품상단내용</th>
            <td><?php echo help("모바일 강의상품상세설명 페이지 상단에 출력하는 HTML 내용입니다."); ?><?php // echo editor_html('it_mobile_head_html', get_text($it['it_mobile_head_html'], 0)); ?></td>
            <td class="td_grpset">
        ...
        <tr  style="display:none">
            <th scope="row">모바일 강의상품하단내용</th>
            <td><?php echo help("모바일 강의상품상세설명 페이지 하단에 출력하는 HTML 내용입니다."); ?><?php //echo editor_html('it_mobile_tail_html', get_text($it['it_mobile_tail_html'], 0)); ?></td>
            <td class="td_grpset">
...
<section id="anc_sitfrm_extra">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                <?php echo help("강의상품을 처음 입력(등록)한 시간입니다."); ?>
                <?php echo $it['it_time']; ?>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <?php echo help("강의상품을 최종 수정한 시간입니다."); ?>
...
<div class="btn_fixed_top">
    <a href="./itemlec_list.php?<?php echo $qstr; ?>" class="btn btn_02">목록</a>
    <a href="<?php echo G5_SHOP_URL ;?>/item.php?it_id=<?php echo $it_id ;?>" class="btn_02  btn">강의상품보기</a>
...
function codedupcheck(id)
{
    ...
    if(it_id.length > 0) {
        alert("강의상품코드는 영문자, 숫자, -, _ 만 사용할 수 있습니다.");
        return false;
    }
    ...
    $.post(
        ...
        function(data) {
            if(data.name) {
                ...
                document.fitemlec_form.codedup.value = '';
            }
        }, "json"
    );
}

function fitemlec_formcheck(f)
{
    if (!f.ca_id.value) {
        alert("기본분류를 선택하십시오.");
        f.ca_id.focus();
...
categorychange(document.fitemlec_form);
</script>
