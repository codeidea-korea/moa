...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="album_content">앨범기본설명<?php echo $sound_only ?></label></th>
        <td>
            <textarea name="album_basic" id="album_basic" class=" frm_input "><?php echo $album['album_basic'];?></textarea>
        </td>
    </tr>
    <tr>
