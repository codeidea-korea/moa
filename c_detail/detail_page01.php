...
//모임상세 페이지 화면 [오프라인] N_회차고정형 타이틀 모임활동 변경해야함
...
include_once(MOA_DETAIL_SKIN."/d_03schedule.skin.php");
include_once(MOA_DETAIL_SKIN."/d_04_1schedule.skin.php");
include_once(MOA_DETAIL_SKIN."/d_05tab.skin.php");
include_once(MOA_DETAIL_SKIN."/d_06curriculum.skin.php");
include_once(MOA_DETAIL_SKIN."/d_07h_intro.skin.php");
