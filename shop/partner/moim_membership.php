...
if($wr_id == '') {
    ...
    $query = "SELECT distinct a.*, m.mb_name, m.mb_sex, m.mb_birth, m.mb_hp, m.job_group, m.mb_id as uid, i.it_name as it_name FROM deb_class_aplyer a LEFT JOIN g5_member m ON m.mb_id=a.mb_id 
