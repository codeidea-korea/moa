...
$wr_id = $_GET['wr_id'];
if($wr_id == '') {
    $query = "select a.*, m.mb_name, m.mb_id as uid from deb_class_aplyer a left join g5_member m on m.mb_id = a.mb_id left join g5_write_class c on a.wr_id = c.wr_id ";
