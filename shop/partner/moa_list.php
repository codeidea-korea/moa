...
//$reqstr = str_replace("https://".$_SERVER['HTTP_HOST'],"", $_SERVER['REQUEST_URI']);s
//$reqstr = str_replace("http://".$_SERVER['HTTP_HOST'],"", $_SERVER['REQUEST_URI']);
//echo "<BR><BR><BR>".$_SERVER['REQUEST_URI']."<BR>";
//echo "<BR><BR><BR>".$reqstr."<BR>";

$chks = false;
foreach($admurl as $k => $v) {
    if (strrpos($_SERVER['REQUEST_URI'], $v) !== false) {
        $chks = true;
    }
...
$host_skin_url = "/shop/partner/skin/Basic";
$host_skin_path = G5_PATH."/shop/partner/skin/Basic";



//include_once(G5_PATH."/adm/admin.lib.php");
//include_once(G5_PATH."/adm/apms_admin/apms.pmenu.php");
//include_once(G5_PATH."/adm/admin.head.php");
//include_once(G5_PATH."/head.sub.admin.php");
//include_once(G5_PATH."/skin/admin/adms/head.php");
if ($chks) {
        
    include_once(G5_ADMIN_PATH.'/admin.head.sub.php');
    include_once($host_skin_path.'/_head.php');
...
include_once($moa_adm_bbs_path.'/board_head.php');
...
if (isset($wr_id) && $wr_id) {
    ...
    include_once ($moa_adm_bbs_path.'/view.php');
}

// 전체목록보이기 사용이 "예" 또는 wr_id 값이 없다면 목록을 보임
//if ($board['bo_use_list_view'] || empty($wr_id))
if ($is_show_list)
    include_once ($moa_adm_bbs_path.'/list.php');
    //echo "is show list";
    //echo "<BR>".$moa_adm_bbs_path."<BR>";
    ...
    if ($chks) {
        ...
        include_once($moa_adm_bbs_path.'/board_tail.php');
