...
<header id="topContainer">
	...
	<ul class="gbMenu">
		...
		<li id="tnb_logout"><a href="<?php echo $at_href['logout'];?>">로그아웃</a></li>
	</ul>
			...
			<nav id="nav">
				<ul id="nav_ul">
					...
					<li>
						<a href="#">내정보</a>
						<ul>
							<li class="<?=$ap == 'register_form'?'active':''?>"><a href="/shop/partner/?ap=register_form" ta rget="_blank">프로필 관리</a></li>
					...
					<li>
						<a href="#">모임관리</a>
						<ul>
							<li class="<?=$ap == 'moa_write' || $ap == 'list' ?'active':''?>"><a href="/shop/partner/?ap=list">모임 내역</a></li>
							<!--<li class=""><a href="#">진행중인 모임</a></li>-->
							<li class="<?=$ap == 'moim_membership'?'active':''?>"><a href="/shop/partner/?ap=moim_membership">모임 신청자 관리</a></li>
							<li class="<?=$ap == 'qalist'?'active':''?>"><a href="/shop/partner/?ap=qalist">문의 관리</a></li>
