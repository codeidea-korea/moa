		...
		<div class="box-block">
			...
			<div class="content" style="padding-bottom:20px;">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label for="pt_type"><b>호스트 유형</b><strong class="sound_only"> 필수</strong></label>
							<select name="pt_type" required class="form-control input-sm">
								<option value="">호스트 유형을 선택해 주세요.</option>
								<?php if($is_company) { ?>
									<option value="1">기업 호스트</option>
								<?php } ?>
								<?php if($is_personal) { ?>
				...
				<div class="form-group checkbox">
					<label>
						<input type="checkbox" name="agree" value="1" id="agree11" style="border:1px solid #333;width:15px;height:15px"> 호스트가입약관과 상기 정보제공에 동의합니다.
					</label>
				</div>
				<div class="form-group">
