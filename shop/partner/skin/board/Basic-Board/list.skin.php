			...
			<div class="list-btn ">
				<div class="form-group pull-right">
					<div class="btn-group dropup " role="group">
						<ul class="dropdown-menu sort-drop none" role="menu" aria-labelledby="sortLabel">
							<li>
						...
						<a id="sortLabel" role="button" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-<?php echo $btn1;?> btn-sm none">
							<?php 
								switch($sst) {
				...
				<div class="form-group pull-left">
					<div class="btn-group" role="group">
						...
						<?php } ?>
						<a role="button" href="#" class="btn btn-<?php echo $btn1;?> btn-sm none" data-toggle="modal" data-target="#searchModal" onclick="return false;"><i class="fa fa-search"></i><span class="hidden-xs"> 검색</span></a>
					</div>
				</div>
