...
<div class="boxContainer padding40">
	...
	<div class="wr-wrap gap10 label200">
		...
		<div class="wr-list" id="moimSchedule2">
			...
			<div class="wr-list-con">
				<input type="text" name="moa_reglimittime"  id="moa_reglimittime" value="<?php echo $write['moa_reglimittime']; ?>" class="span100" placeholder="" min="1" max="100" data-label="모임" data-label-inline="일"> 이전까지 신청 가능
			</div>
		</div>
		<?php 
	$addkind = array(
	...
	?>
		...
		<div class="wr-list">
				...
				<select  name="moa_area1" id="moa_area1" class="form-control input-sm input-small" required style="padding-top:0;">							
