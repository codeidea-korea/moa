...
<div class="boxContainer padding40">
	...
	<div class="wr-wrap gap10 label200">
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td class="bg">
									<label class="inp-wrap inline-label span"><input type="text" name="cls_timelimit[]" value="" class="span" maxlength="3"><span class="label-inline">분</span></label>									
								</td>
								<td class="bg">
		...
		<div class="wr-list" id="moimSchedule2">
			...
			<div class="wr-list-con">
				<input type="text" name="moa_reglimittime"  id="moa_reglimittime" value="<?php echo $write['moa_reglimittime']; ?>" class="span100" placeholder="" data-label="모임" data-label-inline="일"> 이전까지 신청 가능
			</div>
		</div>
		...
		<div class="wr-list" >
			...
			<div class="wr-list-con">
				<input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="span900" placeholder="모임 제목을 입력해주세요." size="50" maxlength="255">
			</div>
		</div>
		<div class="wr-list">
		...
		<div class="wr-list">
				<div class="wr-list-label required">지역</div>
				<div class="wr-list-con">
		...
		$result = sql_query($sql); ?>
		<div class="wr-list">
			<div class="wr-list-label required">상세지역</div>
			<div class="wr-list-con">
...
function add_list() {
	...
	<?php for($i=1; $i<=24; $i++) {
		$i = $i < 10 ? "0".$i:$i;
	?>
	list += '					<option><?php echo $i?>시</option>';
	<?php } ?>
	list += '				</select>';
	list += '				<select name="cls_minite" class="" title="몇분"><option value="">몇분</option>';
	<?php for($i=0; $i<=59; $i+=10) {
		$i = $i < 10 ? "0".$i:$i;
	?>
	list += '					<option><?php echo $i?>분</option>';
	<?php } ?>
	list += '				</select>';
	list += '			</div>';
	list += '		</td>';
	list += '		<td class="bg">';
	list += '			<label class="inp-wrap inline-label span"><input type="text" name="cls_timelimit" value="" class="span" maxlength="2"><span class="label-inline">분</span></label>	';
	list += '		</td>';
	// list += '		<td class="bg">';
	// list += '			<div class="flex flex-middle relative">';
	// list += '				<label class="inp-wrap left-label inline-label"><span class="label">최소</span><input type="text" name="cls_minman" value="" class="span80" placeholder=""><span class="label-inline">명</span></label>';
	// list += '				<span class="color-light">~</span>';
	// list += '				<label class="inp-wrap left-label inline-label"><span class="label">최대</span><input type="text" name="cls_maxman" value="" class="span80" placeholder=""><span class="label-inline">명</span></label>';
