...
<div class="section-title">모임 <?=$w?'수정':'등록'?></div>
...
<input type="hidden" name="page" value="<?php echo $page ?>">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label"><?php echo ($is_category) ? '카테고리 설정' : '옵션';?></label>
		<div class="col-sm-6">
			<?php if ($is_category) { ?>
	...
	?>
	<div class="form-group">
		<label class="col-sm-2 control-label">모임형태</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">모임타입</label>
		<div class="col-sm-6">
			<?php
			$cnt = 1;
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">모임타입</label>
		<div class="col-sm-6"><?php// if($editor_content_js) echo $editor_content_js; ?></div>
	</div>
	<script src="<?php echo G5_JS_URL; ?>/autosave.js"></script>
	<?php } ?>

	<div class="form-group">
		<label class="col-sm-2 control-label">모임제목<strong class="sound_only">필수</strong></label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">모임내용<strong class="sound_only">필수</strong></label>
		<div class="col-sm-6">					
	...
	<div class="form-group">
		...
		<div class="col-sm-6"><textarea name="moa_curriculum" id="moa_curriculum" class="form-control input-sm input-full" cols="30" rows="5" ><?php echo stripslashes($write['moa_curriculum']);?></textarea></div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">모임진행시간</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">신청가능시간</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">모임포함사항</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">모임불포함사항</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">준비물</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">키워드(해시태그)</br><span style='color:gray;'>(선택)</span></label>
		<div class="col-sm-6">
	...
	$result = sql_query($sql); ?>
	<div class="form-group">
		<label class="col-sm-2 control-label">상세지역</label>
		<div class="col-sm-6">
	...
	?>
	<div class="form-group">
		<label class="col-sm-2 control-label"><?php echo $addkind[$i] ?></label>
		<div class="col-sm-6">
	...
	<div class="form-group ">
		<label class="col-sm-2 control-label">참조링크 #<?php echo $i ?></label>
		<div class="col-sm-6">
	...
	<?php if ($is_file) { ?>
	<div class="form-group">
		<label class="col-sm-2 control-label">모임 이미지</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		...
		<div class="col-sm-6"><?php echo $captcha_html; ?></div>
	</div>
	<?php } ?>
...
function add_list() {
	...
	list += '		<td class="bg">';
	list += '			<label class="inp-wrap inline-label span"><input type="text" name="" value="" class="span datepicker" placeholder="날짜 선택"><span class="label-inline"></span></label>';
	list += '		</td>';
	list += '		<td class="bg">';
	list += '			<div class="flex">';
	list += '				<select class="" title="몇시"><option value="">몇시</option>';
	<?php for($i=1; $i<=24; $i++) {
		$i = $i < 10 ? "0".$i:$i;
	?>
	list += '					<option><?=$i?>시</option>';
	<?php } ?>
	list += '				</select>';
	list += '				<select class="" title="몇분"><option value="">몇분</option>';
	<?php for($i=0; $i<=59; $i++) {
		$i = $i < 10 ? "0".$i:$i;
	?>
	list += '					<option><?=$i?>분</option>';
	<?php } ?>
	list += '				</select>';
	list += '			</div>';
	list += '		</td>';
	list += '		<td class="bg">';
	list += '			<label class="inp-wrap inline-label span"><input type="text" name="" value="" class="span" maxlength="2"><span class="label-inline">분</span></label>	';
	list += '		</td>';
	list += '		<td class="bg">';
	list += '			<div class="flex flex-middle relative">';
	list += '				<label class="inp-wrap left-label inline-label"><span class="label">최소</span><input type="text" name="" value="" class="span80" placeholder=""><span class="label-inline">명</span></label>';
	list += '				<span class="color-light">~</span>';
	list += '				<label class="inp-wrap left-label inline-label"><span class="label">최대</span><input type="text" name="" value="" class="span80" placeholder=""><span class="label-inline">명</span></label>';
	list += '				<span class="btn small gray del-list" style="position:absolute;right:-70px">삭제</span>';
	list += '			</div>';	
	list += '		</td>';
	list += '</tr>';
	var $tr_last = null;
