...
if ($is_member)
{
    $sql_common = " from {$g5['g5_shop_order_table']} as o join g5_shop_cart as c on o.od_id = c.od_id join g5_shop_item as i on c.it_id = i.it_id where o.mb_id = '{$member['mb_id']}' ";
}
else if ($od_id && $od_pwd) // 비회원인 경우 주문서번호와 비밀번호가 넘어왔다면
{
    $sql_common = " from {$g5['g5_shop_order_table']} as o join g5_shop_cart as c on o.od_id = c.od_id join g5_shop_item as i on c.it_id = i.it_id where o.od_id = '$od_id' and o.od_pwd = '$od_pwd' ";
}
...
if (!$is_member)
{
    $sql = " select o.od_id, o.od_time, o.od_ip from {$g5['g5_shop_order_table']} as o join g5_shop_cart as c on o.od_id = c.od_id join g5_shop_item as i on c.it_id = i.it_id where o.od_id = '$od_id' and o.od_pwd = '$od_pwd'  and o.od_id = c.od_id and c.it_id = i.it_id ";
    $row = sql_fetch($sql);
    if ($row['od_id']) {
...
include_once(MOA_DETAIL_SKIN.'/d_p_history01.skin.php');
